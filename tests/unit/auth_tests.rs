...
// Extracted from src/auth/mod.rs for improved readability

// Note: This file contains all auth-related tests including:
// - Token extraction from headers tests
// - Token extraction from query parameters tests
// - Token extraction priority tests
// - JWT validation tests (HS256)
...
use yatagarasu::auth::*;
use yatagarasu::config::{ClaimRule, JwtConfig, TokenSource};
